  ...
  return (
    <footer className="bg-slate-950 pt-12 sm:pt-14 pb-8 border-t border-slate-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mb-10">
          ...
          <div className="grid grid-cols-3 gap-2 sm:gap-6 md:col-span-3">
            ...
            <div>
              ...
              <div className="space-y-2 sm:space-y-3 text-slate-400 text-[11px] sm:text-sm break-all">
        ...
        <div className="border-t border-slate-900 pt-6 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <p className="text-slate-550 text-xs sm:text-sm order-2 md:order-1">© 2026 RailQuick. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
