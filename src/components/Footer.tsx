    ...
    <footer className="bg-slate-950 pt-12 sm:pt-14 pb-8 border-t border-slate-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-8 mb-10">
          ...
          <div>
            <h4 className="text-white font-semibold mb-3 text-sm sm:text-base">Legal</h4>
            <div className="space-y-2 sm:space-y-3">
              <Link href="/terms" className="block text-slate-400 hover:text-white transition-colors text-sm sm:text-base">Terms & Conditions</Link>
              <Link href="/privacy" className="block text-slate-400 hover:text-white transition-colors text-sm sm:text-base">Privacy Policy</Link>
              <Link href="/disclaimer" className="block text-slate-400 hover:text-white transition-colors text-sm sm:text-base">Pilot Disclaimer</Link>
            </div>
          </div>
